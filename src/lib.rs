...
#[derive(Debug)]
pub struct WebpackCoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WebpackCoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WebpackCore processing");
    
    let mut processor = WebpackCoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WebpackCoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WebpackCoreProcessor::new(false);
